...
myEmitter.on("sms", async (arg1, arg2) => {
  try {
    await message(`An order was placed with shipment Id: ${arg1} order Id: ${arg2} check on mail info@civsa.in or support@civsa.in for futher details.`, "+91 8903558873");
  } catch (error) {
    console.error(error);
  }
});
